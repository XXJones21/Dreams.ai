    ...
    <section className="relative z-20 py-20 bg-gradient-to-b from-black-marble/50 to-black-marble">
      <div className="container mx-auto px-6">
          ...
          {agents.map((agent, index) => (
            <div key={index} className="agent-card group">
              <div className="relative p-8 h-full">
                ...
                <h4 className={`text-lg font-inter font-semibold mb-4 bg-gradient-to-r ${agent.color} bg-clip-text text-transparent`}>
                  {agent.title}
                </h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {systemFeatures.map((feature, index) => (
            <div key={index} className="text-center p-6">
              <div className="w-12 h-12 mx-auto mb-4 text-brass">
                <feature.icon className="w-full h-full" />
              </div>
              <h3 className="text-xl font-cinzel font-semibold text-stardust-silver mb-3">
                {feature.title}
              </h3>
        ...
        <div className="mt-20 p-8 glass-card">
          <h3 className="text-2xl font-cinzel font-bold text-center text-stardust-silver mb-8">
            How Dreams.ai Works
          </h3>
