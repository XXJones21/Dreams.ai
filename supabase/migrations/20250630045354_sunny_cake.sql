/*
  ...
  1. New Tables
    ...
    - `auth_logs` for security monitoring
...
CREATE POLICY "Users can upload profile pictures"
  ...
  WITH CHECK (
    ...
    octet_length(decode(encode(metadata->'size'::text, 'escape'), 'escape')) <= 5242880
  );
...
-- Note: These will only work if pg_cron is enabled in your Supabase instance
